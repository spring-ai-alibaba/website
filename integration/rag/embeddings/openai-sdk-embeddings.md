...
注意：此实现使用来自 OpenAI 的官方 link:https://github.com/openai/openai-java[OpenAI Java SDK]。有关替代的 Spring AI 实现，请参阅 [OpenAI Embeddings](api/embeddings/openai-embeddings.adoc)。
...
有关 `OpenAiSdkChatModel` 的更多信息，请参阅 [OpenAI SDK Chat](api/chat/openai-sdk-chat.adoc) 部分。
