...
Spring AI 通过重用现有的 [OpenAI](api/chat/openai-chat) 客户端与 [Groq](https://groq.com/) 集成。
...
![spring-ai-groq-integration.jpg](spring-ai-groq-integration.jpg)
...
![spring-ai-groq-functions-2.jpg](spring-ai-groq-functions-2.jpg)
