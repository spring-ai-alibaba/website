...
> 🔗 **仓库地址**：[https://github.com/spring-ai-alibaba/AssistantAgent](https://github.com/spring-ai-alibaba/AssistantAgent)

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/alibaba/assistant-agent/blob/main/LICENSE)
...
#### 入门必读
- [项目结构与主入口](introduce/architecture.md) - 了解整体架构和核心入口

#### 核心模块
- [评估模块（Evaluation）](features/evaluation/quickstart.md) - 多维度意图识别
- [Prompt Builder](features/prompt-builder/quickstart.md) - 动态 Prompt 组装

#### 工具扩展
- [MCP 工具](features/mcp/quickstart.md) - MCP 协议工具接入
- [动态 HTTP 工具](features/dynamic-http/quickstart.md) - REST API 工具接入
- [自定义 CodeAct 工具](features/custom-codeact-tool/quickstart.md) - 自定义工具开发

#### 智能能力
- [经验模块](features/experience/quickstart.md) - 经验积累与复用
- [学习模块](features/learning/quickstart.md) - 自动经验提取
- [搜索模块](features/search/quickstart.md) - 多数据源检索

#### 交互能力
- [回复渠道](features/reply/quickstart.md) - 多渠道消息回复
- [触发器](features/trigger/quickstart.md) - 定时与事件触发
...
本项目采用 Apache License 2.0 许可证 - 详见 [LICENSE](https://github.com/alibaba/assistant-agent/blob/main/LICENSE) 文件。
