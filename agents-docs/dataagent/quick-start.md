...
![Snipaste_2025-09-18_14-35-29.jpg](/img/dataagent/Snipaste_2025-09-18_14-35-29.jpg)
...
![agent-debug.png](/img/dataagent/agent-debug.png)

![vector-initialization.png](/img/dataagent/vector-initialization.png)

成功后可以在智能体调试页面输入自然语言进行查询。

![natural-language-query.png](/img/dataagent/natural-language-query.png)

![query-results.png](/img/dataagent/query-results.png)

> 调试和发布的智能体数据是分离的，调试时的数据不会影响发布后的智能体。

调试没问题后，可以发布智能体。

![publish-agent.png](/img/dataagent/publish-agent.png)

> 目前“嵌入网站”和“访问API”当前版本暂未实现。

点击发布后会更新元数据到发布后的智能体。

![metadata-update.png](/img/dataagent/metadata-update.png)

![publish-complete.png](/img/dataagent/publish-complete.png)
