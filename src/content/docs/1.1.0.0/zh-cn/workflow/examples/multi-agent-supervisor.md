---
title: 多Agent监督者模式
description: 使用LLM编排不同Agent的多智能体监督者模式示例，实现Agent组和任务委托
keywords: [多Agent, Multi-agent, Supervisor, 监督者, Agent编排, 任务委托, Agent组]
---
...
class State extends OverAllState {
...
// Spring AI Alibaba uses JSON-based serialization
...
import java.util.Map;
        ...
        @Override
class SupervisorAgent implements NodeAction {
...
![png](/img/graph/examples/multi-agent-supervisor_files/multi-agent-supervisor_23_0.png)
