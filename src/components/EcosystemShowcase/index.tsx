...
const frameworkItems: EcosystemItem[] = [
  ...
  {
    name: 'Spring AI Alibaba Graph Community',
    nameId: 'ecosystem.framework.graphCommunity.name',
    description: 'Spring AI Alibaba Graph Community.',
    descriptionId: 'ecosystem.framework.graphCommunity.description',
    icon: '🌐',
    repoUrl: 'https://github.com/spring-ai-alibaba/spring-ai-alibaba-graph-community',
  ...
  },
  {
    ...
    docUrl: '/docs/frameworks/admin/quick-start',
        ...
        <div className={styles.cardLinks}>
          {item.docUrl && (
            <Link to={item.docUrl} className={styles.cardLink}>
              <svg className={styles.docIcon} viewBox="0 0 24 24" fill="currentColor">
